...
public:
	...
	~pulse_elim_solver();
	void clear_results();
	void pulse_analysis_elimmethod_start(const nodes_list_store& model_nodes,
...
private:
	...
	void create_pulse_load_matrices(pulse_load_elim_data& pulse_loads,
		const load_data& ld,
