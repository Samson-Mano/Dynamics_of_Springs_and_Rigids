#include "forcedresp_elim_solver.h"

forcedresp_elim_solver::forcedresp_elim_solver()
{
	// Empty constructor
}
...
void forcedresp_elim_solver::get_reduced_global_vector(Eigen::VectorXd& reducedglobalVector,
...
void forcedresp_elim_solver::get_global_resp_vector(Eigen::VectorXd& globalVector,
...
void forcedresp_elim_solver::get_steady_state_harmonic_periodic_soln(double& steady_state_displ_resp,
	double& phase_resp,
