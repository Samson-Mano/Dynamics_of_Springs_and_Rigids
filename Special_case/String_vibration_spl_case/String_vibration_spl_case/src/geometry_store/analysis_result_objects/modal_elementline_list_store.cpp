...
void modal_elementline_list_store::set_rigid_element_line(modal_elementline_store& rline, const int& selected_mode, line_list_store& modal_element_lines)
{
	...
	displ_ratio_1 = static_cast<float>(geom_parameters::get_line_length(origin, temp_pt1_offset));
	displ_ratio_2 = static_cast<float>(geom_parameters::get_line_length(origin, temp_pt2_offset));
